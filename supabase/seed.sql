...
(
  ...
  'იბერია 1999 თბილისის აკადემია',
  'iberia-1999-tbilisi-academy',
  'Tbilisi',
  'Tbilisi',
  'FC Iberia 1999''s (formerly Saburtalo) youth development program, known for producing technically gifted midfielders and wingers. One of the strongest academies in the Erovnuli Liga system.',
  'იბერია 1999-ის (ყოფილი საბურთალო) ახალგაზრდული განვითარების პროგრამა, ცნობილია ტექნიკურად ნიჭიერი ნახევარმცველებისა და მეფრთეების აღზრდით. ეროვნული ლიგის ერთ-ერთი უძლიერესი აკადემია.',
  'https://fciberia1999.ge'
),
(
...
-- Iberia 1999 Tbilisi Academy (4 players)
insert into public.players (id, club_id, name, name_ka, slug, date_of_birth, position, preferred_foot, height_cm, weight_kg, jersey_number, platform_id, status, is_featured, scouting_report, scouting_report_ka) values
(
