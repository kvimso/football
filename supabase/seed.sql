...
-- Dinamo
('b1b2c3d4-0001-4000-8000-000000000001', '2025-26', 14, 11, 3, 1180, 72.50, 28, 8, 3, 0, 108.40, 185, 'manual'),
('b1b2c3d4-0002-4000-8000-000000000002', '2025-26', 16, 4, 9, 1385, 88.30, 12, 32, 18, 0, 142.60, 210, 'manual'),
('b1b2c3d4-0003-4000-8000-000000000003', '2025-26', 15, 1, 1, 1350, 82.10, 2, 48, 35, 7, 118.20, 145, 'manual'),
('b1b2c3d4-0004-4000-8000-000000000004', '2025-26', 16, 0, 0, 1440, 65.00, 0, 0, 0, 6, 62.50, 42, 'manual'),
-- Saburtalo
('b1b2c3d4-0005-4000-8000-000000000005', '2025-26', 15, 7, 8, 1260, 76.40, 22, 6, 2, 0, 138.90, 245, 'manual'),
('b1b2c3d4-0006-4000-8000-000000000006', '2025-26', 14, 8, 6, 1150, 81.20, 20, 12, 5, 0, 125.30, 178, 'manual'),
('b1b2c3d4-0007-4000-8000-000000000007', '2025-26', 16, 2, 0, 1430, 78.50, 4, 52, 38, 8, 120.80, 155, 'manual'),
('b1b2c3d4-0008-4000-8000-000000000008', '2025-26', 15, 3, 4, 1310, 79.60, 10, 42, 28, 0, 152.40, 230, 'manual'),
-- Torpedo
('b1b2c3d4-0009-4000-8000-000000000009', '2025-26', 13, 5, 6, 1050, 74.80, 15, 5, 3, 0, 122.70, 220, 'manual'),
('b1b2c3d4-0010-4000-8000-000000000010', '2025-26', 14, 10, 2, 1200, 68.30, 25, 10, 4, 0, 98.60, 135, 'manual'),
('b1b2c3d4-0011-4000-8000-000000000011', '2025-26', 15, 2, 7, 1290, 87.10, 8, 28, 22, 0, 135.20, 168, 'manual'),
('b1b2c3d4-0012-4000-8000-000000000012', '2025-26', 14, 0, 0, 1260, 62.40, 0, 0, 0, 5, 58.30, 38, 'manual');

-- ============================================================
-- MATCHES (5)
-- ============================================================
insert into public.matches (id, home_club_id, away_club_id, slug, home_score, away_score, competition, match_date, venue, match_report, match_report_ka) values
(
...
insert into public.match_player_stats (match_id, player_id, minutes_played, goals, assists, pass_accuracy, shots, shots_on_target, tackles, interceptions, distance_km, sprints, top_speed_kmh, rating) values
('c1b2c3d4-0001-4000-8000-000000000001', 'b1b2c3d4-0001-4000-8000-000000000001', 90, 2, 0, 70.50, 5, 4, 1, 0, 9.80, 18, 31.2, 8.5),   -- Mikautadze
('c1b2c3d4-0001-4000-8000-000000000001', 'b1b2c3d4-0002-4000-8000-000000000002', 90, 0, 2, 91.20, 2, 1, 3, 2, 10.50, 16, 28.5, 8.2),  -- Zarandia
('c1b2c3d4-0001-4000-8000-000000000001', 'b1b2c3d4-0003-4000-8000-000000000003', 90, 0, 0, 85.00, 0, 0, 5, 4, 8.90, 12, 27.1, 7.3),   -- Lobzhanidze
('c1b2c3d4-0001-4000-8000-000000000001', 'b1b2c3d4-0004-4000-8000-000000000004', 90, 0, 0, 62.00, 0, 0, 0, 0, 4.20, 3, 18.0, 7.0),    -- Nika K. (GK)
('c1b2c3d4-0001-4000-8000-000000000001', 'b1b2c3d4-0005-4000-8000-000000000005', 90, 1, 0, 72.30, 4, 2, 0, 0, 10.20, 22, 33.1, 7.5),  -- Basilashvili
('c1b2c3d4-0001-4000-8000-000000000001', 'b1b2c3d4-0006-4000-8000-000000000006', 85, 0, 1, 78.60, 3, 1, 2, 1, 9.40, 15, 29.8, 6.8),   -- Kirtadze

-- Match 2: Torpedo 2-2 Dinamo
('c1b2c3d4-0002-4000-8000-000000000002', 'b1b2c3d4-0001-4000-8000-000000000001', 90, 1, 0, 68.20, 4, 2, 0, 1, 9.60, 17, 31.0, 7.5),   -- Mikautadze
('c1b2c3d4-0002-4000-8000-000000000002', 'b1b2c3d4-0002-4000-8000-000000000002', 90, 1, 0, 85.50, 3, 2, 4, 3, 10.80, 15, 28.0, 7.8),  -- Zarandia
('c1b2c3d4-0002-4000-8000-000000000002', 'b1b2c3d4-0009-4000-8000-000000000009', 90, 1, 0, 70.10, 3, 2, 1, 0, 10.10, 20, 32.5, 7.8),  -- Zurab D.
('c1b2c3d4-0002-4000-8000-000000000002', 'b1b2c3d4-0010-4000-8000-000000000010', 90, 1, 0, 65.40, 4, 2, 2, 1, 8.50, 10, 26.8, 7.2),  -- Shengelia
('c1b2c3d4-0002-4000-8000-000000000002', 'b1b2c3d4-0011-4000-8000-000000000011', 90, 0, 1, 89.20, 1, 0, 3, 3, 10.40, 14, 27.0, 7.4),  -- Tsitaishvili

-- Match 3: Saburtalo 2-0 Torpedo
('c1b2c3d4-0003-4000-8000-000000000003', 'b1b2c3d4-0005-4000-8000-000000000005', 90, 1, 0, 75.00, 3, 2, 1, 0, 10.50, 24, 33.5, 8.0),  -- Basilashvili
('c1b2c3d4-0003-4000-8000-000000000003', 'b1b2c3d4-0006-4000-8000-000000000006', 90, 1, 1, 83.40, 4, 3, 1, 0, 9.80, 16, 30.2, 8.3),   -- Kirtadze
('c1b2c3d4-0003-4000-8000-000000000003', 'b1b2c3d4-0007-4000-8000-000000000007', 90, 0, 0, 80.20, 1, 0, 6, 5, 8.60, 11, 26.5, 7.8),   -- Jikia
('c1b2c3d4-0003-4000-8000-000000000003', 'b1b2c3d4-0008-4000-8000-000000000008', 90, 0, 1, 81.00, 2, 1, 5, 3, 11.20, 19, 29.0, 7.5),  -- Vakhtang S.
('c1b2c3d4-0003-4000-8000-000000000003', 'b1b2c3d4-0010-4000-8000-000000000010', 90, 0, 0, 62.50, 3, 1, 1, 0, 8.20, 9, 26.0, 5.5),    -- Shengelia

-- Match 4: Dinamo 4-1 Torpedo
('c1b2c3d4-0004-4000-8000-000000000004', 'b1b2c3d4-0001-4000-8000-000000000001', 90, 3, 0, 74.00, 7, 5, 0, 0, 10.00, 20, 31.5, 9.2),  -- Mikautadze hat-trick
('c1b2c3d4-0004-4000-8000-000000000004', 'b1b2c3d4-0002-4000-8000-000000000002', 90, 1, 2, 90.50, 2, 2, 2, 1, 10.60, 14, 28.2, 8.8),  -- Zarandia
('c1b2c3d4-0004-4000-8000-000000000004', 'b1b2c3d4-0003-4000-8000-000000000003', 90, 0, 0, 88.00, 0, 0, 4, 3, 8.80, 10, 26.8, 7.5),   -- Lobzhanidze
('c1b2c3d4-0004-4000-8000-000000000004', 'b1b2c3d4-0010-4000-8000-000000000010', 90, 1, 0, 60.20, 3, 2, 1, 0, 8.10, 8, 25.5, 6.2),    -- Shengelia (pen)
('c1b2c3d4-0004-4000-8000-000000000004', 'b1b2c3d4-0012-4000-8000-000000000012', 90, 0, 0, 58.00, 0, 0, 0, 0, 4.00, 3, 17.5, 5.0),    -- Mate T. (GK)

-- Match 5: Saburtalo 1-1 Dinamo (Cup Semifinal)
('c1b2c3d4-0005-4000-8000-000000000005', 'b1b2c3d4-0005-4000-8000-000000000005', 90, 0, 0, 73.50, 3, 1, 0, 1, 10.30, 21, 32.8, 6.8),  -- Basilashvili
('c1b2c3d4-0005-4000-8000-000000000005', 'b1b2c3d4-0006-4000-8000-000000000006', 90, 1, 0, 80.00, 2, 2, 1, 0, 9.50, 14, 29.5, 7.8),   -- Kirtadze (chip goal)
