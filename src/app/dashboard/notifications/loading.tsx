  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="mb-4 flex gap-2">
        <div className="h-8 w-28 rounded-lg bg-background-secondary" />
      ...
      <div className="rounded-lg border border-border bg-card overflow-hidden divide-y divide-border/50">
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="flex items-start gap-3 px-4 py-3">
            <div className="mt-0.5 h-4 w-4 rounded bg-background-secondary shrink-0" />
            <div className="flex-1 space-y-1.5">
              <div className="h-4 w-3/4 rounded bg-background-secondary" />
              <div className="h-3 w-1/2 rounded bg-background-secondary" />
              <div className="h-4 w-16 rounded-full bg-background-secondary" />
            </div>
          </div>
        ))}
      </div>
