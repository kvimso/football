...
export default async function DashboardPage() {
  ...
  const [watchlistResult, conversationResult, unreadResult, notificationsResult] =
    await Promise.all([
  ...
  if (conversationResult.error)
    console.error('Failed to fetch conversation count:', conversationResult.error.message)
  if (unreadResult.error) console.error('Failed to fetch unread count:', unreadResult.error.message)
  if (notificationsResult.error)
    console.error('Failed to fetch notifications:', notificationsResult.error.message)
