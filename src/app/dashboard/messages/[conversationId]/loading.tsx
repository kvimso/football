    ...
    <div className="flex h-full flex-col animate-pulse">
      ...
      <div className="flex items-center gap-3 border-b border-border px-4 py-3">
        ...
        <div className="flex items-center gap-2.5">
          <div className="h-9 w-9 rounded-full bg-card-hover" />
      ...
      <div className="flex-1 space-y-3 overflow-hidden px-4 py-6">
        ...
        <div className="flex justify-start">
          <div className="max-w-[65%]">
            <div className="h-3 w-16 mb-1 rounded bg-card-hover" />
            <div className="h-12 w-48 rounded-2xl rounded-bl-md bg-card-hover" />
          </div>
        </div>
        ...
        {/* Received message */}
        <div className="flex justify-start">
          <div className="h-16 w-64 rounded-2xl rounded-bl-md bg-card-hover" />
        </div>
        ...
        {/* Received message */}
        <div className="flex justify-start">
          <div className="h-12 w-52 rounded-2xl rounded-bl-md bg-card-hover" />
        </div>
      </div>
      ...
      <div className="border-t border-border px-3 py-2">
        <div className="flex items-center gap-2">
          <div className="h-9 w-9 rounded-full bg-card-hover" />
          <div className="h-9 flex-1 rounded-lg bg-card-hover" />
          <div className="h-9 w-9 rounded-full bg-card-hover" />
