    ...
    <div className="flex flex-col gap-4 lg:flex-row animate-pulse">
      ...
      <div className="hidden lg:block lg:w-56 shrink-0">
        <div className="rounded-lg border border-border bg-card p-3 space-y-2">
          ...
          <div className="h-7 w-full rounded bg-card-hover" />
          <div className="h-7 w-full rounded bg-card-hover" />
          <div className="h-7 w-full rounded bg-card-hover" />
        </div>
      </div>
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mb-4 flex gap-2">
          <div className="h-8 flex-1 rounded-lg bg-card-hover" />
          <div className="h-8 w-24 rounded-lg bg-card-hover" />
        </div>

        {/* Header */}
        <div className="mb-3 h-6 w-32 rounded bg-card-hover" />
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="card p-3">
              <div className="flex items-center gap-3">
                <div className="h-11 w-11 rounded-lg bg-card-hover" />
