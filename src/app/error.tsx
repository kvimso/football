  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="mx-auto flex max-w-md flex-col items-center px-4 text-center">
        ...
        <h1 className="mt-4 text-xl font-bold text-foreground">{t('common.somethingWentWrong')}</h1>
        <p className="mt-2 text-sm text-foreground-muted">{t('common.errorDescription')}</p>
