          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 flex items-center justify-between gap-2">
                ...
                >
                  {subtitle && (
                    <span className="text-foreground-muted/50">{subtitle} &middot; </span>
                  )}
                  {lastMessagePreview}
                </p>
                {conv.unread_count > 0 && (
                  <span className="flex h-5 min-w-5 shrink-0 items-center justify-center rounded-full bg-primary px-1.5 text-[11px] font-bold text-background">
