...
export function ClubAnnouncements({ announcements, title, noAnnouncements }: ClubAnnouncementsProps) {
            ...
            <div key={a.id} className="rounded-xl border border-border bg-card p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1.5 text-xs text-foreground-muted">{formatted}</p>
                </div>
              </div>
            </div>
          )
